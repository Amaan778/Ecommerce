...
public class Studentsect extends AppCompatActivity {
    TextView linux,software,ins,iot,game;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_studentsect);
        ...
        linux.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Studentsect.this,StudentReport.class);
